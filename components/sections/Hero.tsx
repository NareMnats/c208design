...
export default function Hero() {
  return (
    <section className="relative min-h-screen overflow-hidden bg-[#111111] text-white">
      ...
      {/* Darkens the video so the text remains readable. */}
      <div className="absolute inset-0 bg-black/50" />

      {/* Slight gradient keeps the lower text and buttons readable. */}
      <div className="absolute inset-0 bg-gradient-to-t from-black/55 via-black/10 to-black/20" />

      <Container className="relative z-10 flex min-h-screen items-end pb-14 pt-32 sm:pb-16 md:pb-20 lg:pb-24">
